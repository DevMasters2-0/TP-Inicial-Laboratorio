...
// crud basico
  ...
  crearIncidencia(incidencia: Incidencia){
    ...
    this.db.run("INSERT INTO incidencia (nombre, dni, email, tema, nivelDeRiesgo, localidad, descripcion, fechaDeCreacion, latitud, longitud, estado, image_url) VALUES(?,?,?,?,?,?,?,?,?,?,?,?)",[incidencia.nombre, incidencia.dni, incidencia.email, incidencia.tema,incidencia.nivelDeRiesgo, incidencia.localidad, incidencia.descripcion, incidencia.fechaDeCreacion, incidencia.ubicacion.latitud, incidencia.ubicacion.longitud, incidencia.estado, incidencia.image_url], 
